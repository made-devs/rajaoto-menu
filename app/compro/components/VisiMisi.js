  ...
  return (
    <section className="py-24 px-6">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="mb-4 p-10 md:p-16 rounded-3xl border border-white/10 bg-zinc-950/80 backdrop-blur-xl shadow-2xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          {misiPoints.map((item, idx) => (
            <div
              key={idx}
              className="p-8 rounded-2xl border border-white/5 bg-zinc-950/60 backdrop-blur-lg hover:bg-zinc-900/80 transition-all duration-500 group"
            >
